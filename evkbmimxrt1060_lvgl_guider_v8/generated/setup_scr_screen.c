...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_opa(ui->screen, 72, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen, lv_color_hex(0xff9d00), LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes screen_img_1
	ui->screen_img_1 = lv_img_create(ui->screen);
	lv_obj_add_flag(ui->screen_img_1, LV_OBJ_FLAG_CLICKABLE);
	lv_img_set_src(ui->screen_img_1, &_OIP_alpha_181x110);
	lv_img_set_pivot(ui->screen_img_1, 50,50);
	lv_img_set_angle(ui->screen_img_1, 0);
	lv_obj_set_pos(ui->screen_img_1, 36, 17);
	lv_obj_set_size(ui->screen_img_1, 181, 110);
	...
	lv_img_set_src(ui->screen_img_2, &_photo_6168027389217584763_y_alpha_176x122);
	lv_img_set_pivot(ui->screen_img_2, 50,50);
	lv_img_set_angle(ui->screen_img_2, 0);
	lv_obj_set_pos(ui->screen_img_2, 41, 139);
	lv_obj_set_size(ui->screen_img_2, 176, 122);
	...
	lv_img_set_src(ui->screen_img_3, &_R_alpha_180x115);
	lv_img_set_pivot(ui->screen_img_3, 50,50);
	lv_img_set_angle(ui->screen_img_3, 0);
	lv_obj_set_pos(ui->screen_img_3, 246, 79);
	lv_obj_set_size(ui->screen_img_3, 180, 115);
	...
	lv_obj_set_pos(ui->screen_btn_1, 406, 215);
	...
	lv_obj_set_style_text_font(ui->screen_btn_1, &lv_font_Acme_Regular_30, LV_PART_MAIN|LV_STATE_DEFAULT);
