...
/*! @brief Define USER_FAN */
#define LOGIC_FAN_ON  (1U)
#define LOGIC_FAN_OFF (0U)
#ifndef BOARD_USER_FAN_GPIO
#define BOARD_USER_FAN_GPIO GPIO1
#endif
#ifndef BOARD_USER_FAN_GPIO_PIN
#define BOARD_USER_FAN_GPIO_PIN (18U)
#endif

#define USER_FAN_INIT(output)                                            \
    GPIO_PinWrite(BOARD_USER_FAN_GPIO, BOARD_USER_FAN_GPIO_PIN, output); \
    BOARD_USER_FAN_GPIO->GDIR |= (1U << BOARD_USER_FAN_GPIO_PIN)                       /*!< Enable target USER_FAN */
#define USER_FAN_ON() GPIO_PortSet(BOARD_USER_FAN_GPIO, 1U << BOARD_USER_FAN_GPIO_PIN) /*!<Turn on target USER_FAN*/
#define USER_FAN_OFF() \
    GPIO_PortClear(BOARD_USER_FAN_GPIO, 1U << BOARD_USER_FAN_GPIO_PIN) /*!< Turn off target USER_FAN */
#define USER_FAN_TOGGLE()                                       \
    GPIO_PinWrite(BOARD_USER_FAN_GPIO, BOARD_USER_FAN_GPIO_PIN, \
                  0x1 ^ GPIO_PinRead(BOARD_USER_FAN_GPIO, BOARD_USER_FAN_GPIO_PIN)) /*!< Toggle target USER_FAN */
