...
clean-board:
	-$(RM) ./board/board.d ./board/board.o ./board/clock_config.d ./board/clock_config.o ./board/dcd.d ./board/dcd.o ./board/lvgl_support.d ./board/lvgl_support.o ./board/pin_mux.d ./board/pin_mux.o
