...
void setup_scr_ui_Aircon(lv_ui *ui)
{
	...
	ui->g_kb_ui_Aircon = lv_keyboard_create(ui->ui_Aircon);
	lv_obj_add_event_cb(ui->g_kb_ui_Aircon, kb_event_cb, LV_EVENT_ALL, NULL);
	lv_obj_add_flag(ui->g_kb_ui_Aircon, LV_OBJ_FLAG_HIDDEN);
	lv_obj_set_style_text_font(ui->g_kb_ui_Aircon, &lv_font_montserratMedium_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_icn_fan_low, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_icn_dry, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_icn_fan_high, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_icn_fan, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_icn_cool, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_aircon_cool, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_aircon_fan, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_scrollbar_mode(ui->ui_Aircon_aircon_swing, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TempUp, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TempUp, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TempDown, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TempDown, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TimerUp, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TimerUp, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TimerDown, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->ui_Aircon_Btn_TimerDown, &lv_font_simsun_11, LV_PART_MAIN|LV_STATE_PRESSED);
