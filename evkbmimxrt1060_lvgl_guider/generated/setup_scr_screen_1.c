...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_1_img_1, 25, 16);
	lv_obj_set_size(ui->screen_1_img_1, 433, 102);
	...
	lv_obj_set_pos(ui->screen_1_Temp, 62, 146);
	lv_obj_set_size(ui->screen_1_Temp, 100, 32);
	...
	lv_obj_set_style_bg_opa(ui->screen_1_Temp, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_1_T_plus, 10, 119);
	lv_obj_set_size(ui->screen_1_T_plus, 41, 35);
	...
	lv_obj_set_style_bg_color(ui->screen_1_T_plus, lv_color_hex(0xD01FBB), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_1_T_plus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_1_T_plus, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_1_T_plus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_1_T_plus, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_1_T_plus, &lv_font_Alatsi_Regular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_1_T_minus, 10, 167);
	lv_obj_set_size(ui->screen_1_T_minus, 41, 35);
	...
	lv_obj_set_style_bg_color(ui->screen_1_T_minus, lv_color_hex(0xD01FBB), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_1_T_minus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_1_T_minus, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_1_T_minus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_1_T_minus, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_1_T_minus, &lv_font_Alatsi_Regular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_1_H_minus, 220, 167);
	...
	lv_obj_set_pos(ui->screen_1_H_plus, 220, 114);
	...
	lv_obj_set_pos(ui->screen_1_Humidity, 292, 149);
	lv_obj_set_size(ui->screen_1_Humidity, 100, 32);
	...
	lv_obj_set_style_bg_opa(ui->screen_1_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
