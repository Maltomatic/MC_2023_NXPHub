...
void setup_scr_screen_3(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_3_img_1, 25, 16);
	lv_obj_set_size(ui->screen_3_img_1, 433, 102);
	...
	ui->screen_3_Temp = lv_label_create(ui->screen_3);
	lv_label_set_text(ui->screen_3_Temp, "0");
	lv_label_set_long_mode(ui->screen_3_Temp, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_3_Temp, 62, 146);
	lv_obj_set_size(ui->screen_3_Temp, 100, 32);
	lv_obj_set_scrollbar_mode(ui->screen_3_Temp, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_pos(ui->screen_3_T_plus, 10, 119);
	lv_obj_set_size(ui->screen_3_T_plus, 41, 35);
	...
	lv_obj_set_style_bg_color(ui->screen_3_T_plus, lv_color_hex(0xD01FBB), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_3_T_plus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_3_T_plus, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_3_T_plus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_3_T_plus, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_3_T_plus, &lv_font_Alatsi_Regular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_3_T_minus, 10, 167);
	lv_obj_set_size(ui->screen_3_T_minus, 41, 35);
	...
	lv_obj_set_style_bg_color(ui->screen_3_T_minus, lv_color_hex(0xD01FBB), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_3_T_minus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_3_T_minus, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_3_T_minus, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_3_T_minus, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_3_T_minus, &lv_font_Alatsi_Regular_33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_3_H_minus, 220, 167);
	...
	lv_obj_set_pos(ui->screen_3_H_plus, 220, 114);
	...
	//Write codes screen_3_Humidity
	ui->screen_3_Humidity = lv_label_create(ui->screen_3);
	lv_label_set_text(ui->screen_3_Humidity, "0 %");
	lv_label_set_long_mode(ui->screen_3_Humidity, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_3_Humidity, 292, 149);
	lv_obj_set_size(ui->screen_3_Humidity, 100, 32);
	lv_obj_set_scrollbar_mode(ui->screen_3_Humidity, LV_SCROLLBAR_MODE_OFF);

	//Write style for screen_3_Humidity, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_3_Humidity, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_3_Humidity, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->screen_3_Humidity, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->screen_3_Humidity, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_3_Humidity, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
